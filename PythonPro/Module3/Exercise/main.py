...
links = "https://pt.wikipedia.org/wiki/Bicicleta"
...
links_wikipedia = ["https://pt.wikipedia.org" + link['href']
                   for link in tags.find_all("a", href=lambda href: href and href.startswith("/wiki/"))]
